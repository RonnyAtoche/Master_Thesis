...
datasets_path = '/home4/s2614855/JWST/tensorflow_datasets_groups/tensorflow_datasets_group_five/' #Path to dataset
...
group_five = tfds.load(tfds_name_predict,
...
group_five=np.array(group_five)

test_dataset = group_five.take(-1).batch(64).prefetch(tf.data.experimental.AUTOTUNE) 
...
df.to_csv('/scratch/s2614855/JWST/group_five_predicted_values_dataset_raw.csv',index=False)
