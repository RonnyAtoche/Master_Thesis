...
def create_model(input_dim, load_weights=False, filename_model=''):
  ...
  x = Conv2D(32, (11, 11), strides=(2, 2), padding='same', data_format='channels_first', kernel_initializer=initializers.RandomNormal(stddev=0.02))(x)
  x = LeakyReLU(0.2)(x)
  x = BatchNormalization()(x)
  x = Dropout(0.5)(x)

  x = Conv2D(64, (9, 9), strides=(2, 2), padding='same')(x)
  x = LeakyReLU(0.2)(x)
  x = BatchNormalization()(x)
  x = Dropout(0.5)(x)
