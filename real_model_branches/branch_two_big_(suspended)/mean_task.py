...
if __name__ == '__main__':
    ...
    datasets_path = '/data/s2614855/Intro_Project_Data/Intro_Project/tensorflow_datasets/'  # path to training dataset
    output_dir = '/data/s2614855/Intro_Project_Data/Intro_Project/real_model_branches/branch_two_big/model_image/'  # path to save model and images
