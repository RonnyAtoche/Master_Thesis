...
# The calling iterator did not fully read the dataset being cached. In order to avoid unexpected truncation of the dataset, 
...
if __name__ == '__main__':
    ...
    classes = ['merger', 'nonmerger']

    batch_size = 64
    epochs = 100

    tfds_name = 'my_dataset'
    datasets_path = '/data/s2614855/Intro_Project_Data/Intro_Project/tensorflow_dataset_cropped_images_second/tensorflow_datasets/'  # path to training dataset
    output_dir = '/data/s2614855/Intro_Project_Data/Intro_Project/real_model_branches/branch_two_big_model_small_dataset_second/model_image/'  # path to save model and images
