...
datasets_path = '/data/s2614855/Intro_Project_Data/Intro_Project/tensorflow_datasets/' #Path to dataset
filename_model = '/data/s2614855/Intro_Project_Data/Intro_Project/real_model_branches/branch_one/model_image/model.weights_model1.hdf5' #Path+name to model weights
input_dim = (1, 320, 320) #Image dimensions: (channels, rows, cols)
name_plot = 'confusion_matrix' #Path+name to output plot with confusion matrix
output_folder = '/data/s2614855/Intro_Project_Data/Intro_Project/real_model_branches/branch_one/model_image/'
