...
if __name__ == '__main__':
    ...
    output_dir = '/data/s2614855/Intro_Project_Data/Intro_Project/real_model_branches/branch_two_big_model_small_dataset/model_image/'  # path to save model and images
